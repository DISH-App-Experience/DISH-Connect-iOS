...
extension UIColor {
    ...
    static let mainBlue = UIColor(named: "accentColor")!
...
extension UIViewController {
    ...
    func presentDetailedController(controller: String, withAction action: String, withPostId postId: String?) {
        if controller == "category" {
            let controller = MenuCategoryDetailController()
            controller.action = action
            if postId != "none" {
                controller.categoryId = postId
            }
    ...
    func presentEventControllerDetailed(withAction action: String, withPostId postId: String?) {
        let controller = EventsDetailController()
        controller.action = action
        if postId != "none" {
    ...
    func presentPromotionControllerDetailed(withAction action: String, withPostId postId: String?) {
        let controller = PromoDetailController()
        controller.action = action
        if postId != "none" {
            controller.eventId = postId
        }
